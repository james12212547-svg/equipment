...
import { ArrowLeft, Wrench, RefreshCcw, ThermometerSnowflake, Wind, ChevronRight, Sun, Zap } from 'lucide-react';
...
const simulationData = {
      ...
      },
      {
        ...
        nodes: {
          ...
          failReset: {
            result: 'fail',
            title: '❌ ไม่ช่วยอะไร!',
            desc: 'การ Reset คืนค่าโรงงานไม่ได้ทำให้ไฟการไฟฟ้ากลับมา และอาจทำให้การตั้งค่าระบบหรือรหัสผ่านสูญหาย ต้องเสียเวลาตั้งค่าใหม่ทั้งหมด'
          }
        }
      }
    ]
  ...
  electrical: {
    name: 'ระบบไฟฟ้าอาคาร (Electrical)',
    icon: Zap,
    color: '#8B5CF6',
    scenarios: [
      {
        id: 'elec_breaker_trip',
        title: 'เมนเบรกเกอร์ทริปตอนเปิดแอร์พร้อมน้ำอุ่น',
        startNode: 'start',
        nodes: {
          start: {
            question: 'ลูกค้าแจ้งว่า: "ไฟดับทั้งบ้านเลยครับ พอสับเมนเบรกเกอร์ขึ้น แล้วเปิดแอร์กับเครื่องทำน้ำอุ่นพร้อมกัน แป๊บเดียวก็ทริปตกลงมาอีก" คุณคิดว่าเป็นเพราะอะไร?',
            options: [
              { text: 'แอร์คอมเพรสเซอร์ช็อต', next: 'failAcShort' },
              { text: 'ใช้ไฟเกินขนาดเมนเบรกเกอร์ (Overload)', next: 'checkOverload' },
              { text: 'เบรกเกอร์เสื่อมสภาพ', next: 'failBreaker' }
            ]
          },
          checkOverload: {
            question: 'คุณไปดูที่ตู้คอนซูมเมอร์ พบว่าเป็นมิเตอร์ 5(15)A และใช้เมนเบรกเกอร์ขนาด 16A แต่อุปกรณ์มี แอร์ 12000 BTU (ประมาณ 5A) และเครื่องทำน้ำอุ่น 3500W (ประมาณ 16A) คุณจะแนะนำลูกค้าอย่างไร?',
            options: [
              { text: 'เปลี่ยนเมนเบรกเกอร์ให้ใหญ่ขึ้นเป็น 32A ทันที', next: 'failUpgrade' },
              { text: 'แนะนำให้ลูกค้าไปขอขยายขนาดมิเตอร์การไฟฟ้าเป็น 15(45)A พร้อมเดินสายเมนใหม่', next: 'successMeter' }
            ]
          },
          successMeter: {
            result: 'success',
            title: '✅ ถูกต้องและปลอดภัย!',
            desc: 'เยี่ยมมากครับ! การที่แอร์ (5A) และน้ำอุ่น (16A) ทำงานพร้อมกัน จะกินกระแสรวมกว่า 21A ซึ่งเกินกว่าที่มิเตอร์ 5(15)A และเมนเบรกเกอร์ 16A จะรับไหว การขอขยายมิเตอร์เป็น 15(45)A และเปลี่ยนสายเมนเบอร์ 10 พร้อมเมนเบรกเกอร์ 40A/50A คือวิธีที่ถูกต้องและปลอดภัยที่สุด'
          },
          failAcShort: {
            result: 'fail',
            title: '❌ วิเคราะห์ผิดจุด!',
            desc: 'ถ้าแอร์ช็อต เบรกเกอร์จะทริปทันทีที่เปิดแอร์ตัวเดียว ไม่จำเป็นต้องรอเปิดพร้อมเครื่องทำน้ำอุ่นครับ'
          },
          failBreaker: {
            result: 'fail',
            title: '❌ ยังไม่ใช่ประเด็นหลัก!',
            desc: 'เบรกเกอร์อาจเสื่อมได้ แต่นี่เป็นการเปิดโหลดหนักสองตัวพร้อมกัน ควรเช็คขนาดโหลดรวมเทียบกับพิกัดเบรกเกอร์ก่อนเสมอ'
          },
          failUpgrade: {
            result: 'fail',
            title: '❌ อันตรายถึงไฟไหม้!',
            desc: 'การเปลี่ยนเมนเบรกเกอร์ให้ใหญ่ขึ้น (เช่น 32A) โดยไม่เปลี่ยนขนาดสายเมนและมิเตอร์การไฟฟ้า (5(15)A สายเมนเบอร์ 4) จะทำให้สายไฟร้อนจัดและไฟไหม้บ้านได้ก่อนที่เบรกเกอร์จะตัด!'
          }
        }
      }
    ]
